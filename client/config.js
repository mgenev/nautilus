System.config({
  ...
  "bundles": {
    "app-bundle": [
      ...
      "npm:core-js@0.9.5/library/modules/$.fw",
      "npm:babel-runtime@5.1.13/helpers/class-call-check",
      "github:components/jquery@2.1.3/jquery",
      "github:twbs/bootstrap@3.3.4/css/bootstrap.css!github:systemjs/plugin-css@0.1.10",
      "npm:core-js@0.9.5/library/modules/$",
      "github:components/jquery@2.1.3",
      "npm:core-js@0.9.5/library/fn/object/define-property",
      "github:twbs/bootstrap@3.3.4/js/bootstrap",
      "npm:babel-runtime@5.1.13/core-js/object/define-property",
      "github:twbs/bootstrap@3.3.4",
      "npm:babel-runtime@5.1.13/helpers/create-class",
      "app",
      "animation-main"
    ]
  }
